  ...
  return (
    <SafeAreaView className="flex-1 bg-[#84BDEA]">
      ...
      <View className="flex-1 px-4 pb-2 pt-3 mb-1">
        ...
        <View className="bg-[#42779F] rounded-[12] p-4 flex-1" style={shadows.large}>
          <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 16 }}>
            {workouts.map((workout) => (
              <TouchableOpacity key={workout.id} onPress={() => handleWorkoutPress(workout.id)} className="mb-4">
                <Card className="rounded-xl overflow-hidden border-0">
                  ...
                  <View className="flex-row items-center px-4 py-2 bg-gray-800 rounded-b-xl">
                    ...
                    <Text className="text-white ml-2 text-sm">{workout.targetMuscles}</Text>
